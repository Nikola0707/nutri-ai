...
function SubmitButton() {
  ...
  return (
    <Button
      type="submit"
      disabled={pending}
      className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium h-12"
    >
      {pending ? (
        <>
  ...
  return (
    <Card className="w-full max-w-md shadow-xl border-0">
      <CardHeader className="text-center space-y-4">
        ...
        <div>
          <CardTitle className="text-2xl font-bold text-gray-900">Welcome back to NutriAI</CardTitle>
          <CardDescription className="text-gray-600 mt-2">Sign in to continue your nutrition journey</CardDescription>
        </div>
      </CardHeader>
